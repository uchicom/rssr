...
public class Constants {
	...
	public static final String PROP_KEY_WINDOW_RSSR_POSITION = "window.rssr.position";
	public static final String PROP_KEY_WINDOW_RSSR_STATE = "window.rssr.state";
	public static final String PROP_SPLIT_CHAR = ":";
